...
showAll = tk.Button(frameLeft, text='INSERT', font=20, width=20, height=2, fg='white',
                       command=lambda: showAll())
showAll.grid(row=9, column=0, padx=10)
